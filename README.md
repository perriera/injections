...
# [(perriera) / injections](https://github.com/perriera/injections)

Welcome to the **(perriera) / injections** project.
...
> 1. [Generate your project using this template](https://github.com/perriera/injections/generate)<br/>
> **NOTE**: 
> When you create your project the 'injections' specified <br/>below will be replaced with your project name.<br/>
...
> 1. [How to setup a development environment (on Linux, Windows or Mac)](https://github.com/perriera/injections/blob/dev/docs/ENVIRONMENT.md)
> 2. [How to install the tools necessary for C++11/17 projects](https://github.com/perriera/injections/blob/dev/docs/INSTALL.md)
 >3. [How to clone your project (with this template)](https://github.com/perriera/injections/blob/dev/docs/CLONE.md)
> 4. [How to setup your changelog.md](https://github.com/perriera/injections/blob/dev/docs/CHANGELOG.md)
...
> [Open Source / MIT License](https://opensource.org/licenses/MIT) (see [LICENSE.md](https://github.com/perriera/injections/blob/dev/LICENSE.md))<br/>
