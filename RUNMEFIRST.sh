...
git tag -a v0.0.0 -m "created from injections"
...
find . -type f -name *.h* -print0 | xargs -0 sed -i "s/INJECTIONS/$f2/g"
find . -type f -name *.c* -print0 | xargs -0 sed -i "s/INJECTIONS/$f2/g"
find . -type f -name *.t* -print0 | xargs -0 sed -i "s/INJECTIONS/$f2/g"
find . -type f -name '*.md' -print0 | xargs -0 sed -i "s/INJECTIONS/$f2/g"
find . -type f -name *.h* -print0 | xargs -0 sed -i "s/injections/$f1/g"
find . -type f -name *.c* -print0 | xargs -0 sed -i "s/injections/$f1/g"
find . -type f -name *.t* -print0 | xargs -0 sed -i "s/injections/$f1/g"
find . -type f -name '*.md' -print0 | xargs -0 sed -i "s/injections/$f1/g"
...
find . -type f -name launch.json -print0 | xargs -0 sed -i "s/injections/${f1}/g"

mv include/injections include/$f1
mv instances/injections_app.cpp instances/${f1}_app.cpp
